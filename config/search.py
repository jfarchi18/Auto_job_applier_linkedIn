...
search_terms = [
    # Operations & Strategy (your core strength)
    "Director of Operations", "VP Operations", "Head of Operations",
    "Strategy and Operations", "Business Operations Manager", "Operations Manager",
    "Chief of Staff", "General Manager",
    # Healthcare (your industry - 4 years VP experience)
    "Healthcare Operations", "Healthcare Strategy", "Health Systems",
    "Healthcare Manager", "Healthcare Director", "Clinical Operations",
    "Health Tech", "Digital Health", "Telehealth",
    # Finance & Strategy
    "Corporate Development", "Strategic Finance", "FP&A",
    "Financial Planning", "Finance Manager", "Finance Director",
    "Business Development Manager", "Revenue Operations",
    # PE / VC / Investment (your MBA focus)
    "Portfolio Operations", "Operating Associate", "Value Creation",
    "Investment Associate", "Private Equity Associate", "Venture Capital",
    "PE Operations",
    # Broader MBA roles - cast wide net
    "Program Manager", "Product Manager", "Strategy Manager",
    "Strategy Associate", "Strategy Analyst",
    "Transformation Manager", "Change Management",
    "Project Manager", "Management Associate",
    "Business Analyst", "Senior Analyst",
    "Associate Director", "Manager",
]

# Search location, this will be filled in "City, state, or zip code" search box. If left empty as "", tool will not fill it.
search_location = "Boston, Massachusetts, United States"               # Some valid examples: "", "United States", "India", "Chicago, Illinois, United States", "90001, Los Angeles, California, United States", "Bengaluru, Karnataka, India", etc.
...
experience_level = ["Entry level", "Associate", "Mid-Senior level", "Director", "Executive"]              # (multiple select) "Internship", "Entry level", "Associate", "Mid-Senior level", "Director", "Executive"
...
about_company_bad_words = ["McKinsey", "BCG", "Bain", "Deloitte Consulting", "Accenture", "Kearney", "Oliver Wyman", "Roland Berger", "Strategy&", "LEK Consulting", "Alvarez & Marsal"]       # Skip consulting firms
...
current_experience = 6             # Integers > -2 (Ex: -1, 0, 1, 2, 3, 4...) -- 4 yrs Compass + BCG summer + MBA
##
